...
#define _Blink_FX_arr CustomBlob_Tentackles
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult40 = lerp( saturate( ( ( ( _Color * _Mult ) + saturate( temp_output_27_0 ) ) * ( 1.0 - saturate( ( -1.0 * temp_output_27_0 ) ) ) ) ) , _BlinkFX_Color , ( _BlinkFX_Color.a * _Blink_FX_Instance ));
...
Node;AmplifyShaderEditor.SamplerNode;46;-1580.388,-749.3747;Inherit;True;Property;_Mat;Mat;3;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-1713.643,-1362.676;Inherit;False;Property;_Mult;Mult;6;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;104;-1519.478,-1466.693;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-794.8868,-672.7153;Inherit;False;InstancedProperty;_Blink_FX;Blink_FX;5;0;Create;True;0;0;False;0;False;0;0.299;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;37;-824.6475,-972.5625;Inherit;False;Property;_BlinkFX_Color;BlinkFX_Color;4;0;Create;True;0;0;False;0;False;1,0,0,1;1,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;104;0;28;0
WireConnection;104;1;105;0
WireConnection;36;0;104;0
