		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float4 appendResult6 = (float4(( ( ( 1.0 - ( ( 1.0 - lerpResult5 ) * ( 1.0 - _TintColor ) ) ) * i.color ) * temp_output_36_0 ).rgb , ( temp_output_36_0 * _AlphaBlend )));
...
/*ASEBEGIN
Version=18500
522;84;1056.667;867.6667;430.2056;1054.481;2.192483;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;1210.924,50.04522;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=749F5BBDE213911E64ECE44AE9C27CE032397119