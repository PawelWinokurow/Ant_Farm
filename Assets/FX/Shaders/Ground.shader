	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult199 = lerp( _Color , tex2D( _MainTex, ( _MainTex_ST.zw + ( _MainTex_ST.xy * appendResult141 * _ScaleUV ) ) ) , ( _BlendTexture * saturate( (0.5 + (i.ase_texcoord1.xyz.y - 0.0) * (1.0 - 0.5) / (_Heigth - 0.0)) ) ));
				...
				float4 temp_cast_1 = (saturate( (0.1 + (i.ase_texcoord1.xyz.y - 0.0) * (0.0 - 0.1) / (_Heigth - 0.0)) )).xxxx;
...
/*ASEBEGIN
Version=18500
876.6667;72.66667;1207.333;902.3333;1621.888;929.3448;1.798705;True;False
...
Node;AmplifyShaderEditor.PosVertexDataNode;192;-920.767,5.622728;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;199;-745.0737,-839.6573;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=07F7E7E9FD5AF3962E405C86C9FA2D19A4D4E647