	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 temp_cast_1 = ((0.1 + (i.ase_texcoord1.xyz.y - 0.0) * (0.0 - 0.1) / (_Heigth - 0.0))).xxxx;
...
/*ASEBEGIN
Version=18500
464.6667;72.66667;814.6667;972.3333;2046.535;668.5729;1;False;False
...
ASEEND*/
//CHKSM=FDFF2CE4B865A7EBDAF94406BDFF7CA7D7CF6D9E