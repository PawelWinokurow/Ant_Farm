		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float2 appendResult44 = (float2(0.0 , ( mulTime43 * -1.0 )));
					float2 texCoord49 = i.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float temp_output_47_0 = ( 1.0 - texCoord49.y );
					float lerpResult51 = lerp( 1.0 , ( temp_output_47_0 * temp_output_47_0 ) , _TopFade);
					float temp_output_33_0 = ( i.color.a * _TintColor.a * tex2D( _MainTex, ( uv_MainTex + appendResult44 ) ).r * lerpResult51 );
...
/*ASEBEGIN
Version=18500
996.6667;83.33334;1090.667;681;1010.809;565.8433;1.362568;True;False
Node;AmplifyShaderEditor.RangedFloatNode;45;-1658.055,-253.4584;Inherit;False;Property;_TimeScl;TimeScl;2;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;43;-1419.131,-246.4724;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;-1213.267,-246.0523;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;-1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-475.3475,27.05066;Inherit;False;Property;_TopFade;TopFade;3;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;51;-270.199,-135.7858;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-84.29009,-957.459;Inherit;False;Property;_Mult;Mult;1;0;Create;True;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-124.3289,-427.4912;Float;False;Property;_AlphaBlend;AlphaBlend;0;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=1F5F5D954EC1C21E30DBE0D1C64028C21FFED3F9