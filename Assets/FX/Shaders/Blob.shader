...
#define _Blink_FX_arr CustomBlob
			...
			v2f vert ( appdata v )
			{
				...
				float Time127 = ( _Time.y + 0.25 );
				float localSin_Custom127 = Sin_Custom127( Time127 );
				float2 texCoord71 = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float temp_output_112_0 = ( ( ( 0.1 * localSin_Custom127 ) + ( 0.2 * (tex2Dlod( _Tex, float4( ( _Tex_ST.zw + ( _Tex_ST.xy * texCoord71 * 3.0 ) + ( _Time.y * 0.3 ) ), 0, 0.0) ).r*2.0 + -1.0) ) ) + 1.0 );
				float Time126 = _Time.y;
...
/*ASEBEGIN
Version=18500
348;84;944;868;778.4252;1245.792;2.142393;True;False
...
Node;AmplifyShaderEditor.SimpleAddOpNode;128;-1091.551,-128.1348;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.25;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;114;-245.5328,168.71;Inherit;False;2;2;0;FLOAT;0.2;False;1;FLOAT;0.2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;108;-524.8428,-29.96448;Inherit;False;2;2;0;FLOAT;0.1;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;98;-873.4211,587.9805;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;129;-589.9598,420.4213;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=03A941EA98C0753DEF882F2A077AF31FF3A138C2