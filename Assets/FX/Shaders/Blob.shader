...
#define _Blink_FX_arr CustomBlob
			...
			v2f vert ( appdata v )
			{
				...
				float temp_output_64_0 = (0.5 + (tex2Dlod( _Voronoi, float4( ( _Voronoi_ST.zw + ( _Voronoi_ST.xy * texCoord71 * 3.0 ) + ( _Time.y * 0.3 ) ), 0, 0.0) ) - -1.0) * (1.2 - 0.5) / (1.0 - -1.0));
				float3 appendResult52 = (float3(temp_output_64_0 , (0.7 + (sin( ( _Time.y * 10.0 ) ) - -1.0) * (1.0 - 0.7) / (1.0 - -1.0)) , temp_output_64_0));
				float lerpResult96 = lerp( 1.0 , texCoord71.y , ( texCoord71.x * 0.5 ));
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult40 = lerp( float4( 0,0,0,1 ) , _BlinkFX_Color , _Blink_FX_Instance);
				
				
				finalColor = ( saturate( ( ( ( tex2D( _MainTex, ( _MainTex_ST.zw + ( _MainTex_ST.xy * appendResult8 * _ScaleUV ) ) ) * lerpResult32 ) + saturate( temp_output_27_0 ) ) * ( 1.0 - saturate( ( -1.0 * temp_output_27_0 ) ) ) ) ) + lerpResult40 );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18500
1181;84;1043;733;2767.54;1770.952;2.03569;True;False
...
Node;AmplifyShaderEditor.VirtualTextureObject;75;-1778.239,1.252005;Inherit;True;Property;_Voronoi;Voronoi;6;0;Create;True;0;0;False;0;False;-1;None;None;False;white;Auto;Unity5;0;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;71;-1477.305,350.1021;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleTimeNode;55;-1404.578,-56.21268;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-1121.985,6.346853;Inherit;False;Constant;_Float0;Float 0;10;0;Create;True;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;80;-1110.407,446.4548;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.3;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;72;-1145.904,321.0776;Inherit;False;3;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;58;-842.5922,-94.95306;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;68;-776.2817,202.3361;Inherit;True;Property;_Texture3;Texture3;10;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;98;-890.0199,571.3817;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;33;-1272.572,-1282.445;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;57;-669.9815,-100.4087;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;60;-445.5063,-210.5444;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0.7;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;91;-61.23911,-193.0314;Inherit;False;Property;_Forward;Forward;7;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;64;-296.8433,24.89886;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0.5;False;4;FLOAT;1.2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;52;-36.39542,-339.2644;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;37;-850.1287,-728.5369;Inherit;False;Property;_BlinkFX_Color;BlinkFX_Color;8;0;Create;True;0;0;False;0;False;1,0,0,1;1,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;38;-935.4266,-481.7935;Inherit;False;InstancedProperty;_Blink_FX;Blink_FX;9;0;Create;True;0;0;False;0;False;0;0.299;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;94;361.9075,-178.03;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;40;-573.1058,-679.3152;Inherit;False;3;0;COLOR;0,0,0,1;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;70;-395.9772,328.0606;Inherit;False;Constant;_Float1;Float 1;11;0;Create;True;0;0;False;0;False;1.1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;41;-591.2672,-1202.974;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;9;870.4589,-997.6209;Float;False;True;-1;2;ASEMaterialInspector;100;1;Custom/Blob;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;RenderType=Opaque=RenderType;True;2;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=9D4C1C6A8EAECFB2F224DD27F27D143728682A0F