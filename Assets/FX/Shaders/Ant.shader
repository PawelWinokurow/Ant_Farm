...
#define _Blink_FX_arr CustomAnt
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult193 = lerp( ( ( lerpResult141 + saturate( temp_output_183_0 ) ) * ( 1.0 - saturate( ( -1.0 * temp_output_183_0 ) ) ) ) , _BlinkFX_Color , _Blink_FX_Instance);
...
/*ASEBEGIN
Version=18500
1325.5;84;818;679;496.6998;1045.156;1.671158;True;False
...
ASEEND*/
//CHKSM=5767DAA6652BC0E8473FE13082005A74A18CCE4B